...
export default function ProfileForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 md:space-y-10">
      <h1 className="text-3xl md:text-5xl font-bold text-red-600 mb-1">
      ...
      <div className="space-y-6 md:space-y-8">
        ...
        <div className="block mb-3">
          <label
            htmlFor="name"
            className="block text-base md:text-lg font-medium mb-2 md:mb-3"
          >
            Name
          </label>
          <FormInput
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-5">
          <div>
            <label
              htmlFor="email"
              className="block text-base md:text-lg font-medium mb-2 md:mb-3"
        ...
        <div className="space-y-4 mb-5">
          <div className="rounded-lg border border-gray-300 overflow-hidden">
            ...
            <div className="p-4 space-y-4">
              {/* Existing CV option */}
              {user?.hasCV && (
                <div className="p-3 md:p-4 rounded-lg bg-white border border-gray-300">
              ...
              <div className="p-3 md:p-4 rounded-lg bg-white border border-gray-300">
                <div className="flex items-center gap-3 mb-3">
                  <input
                    ...
                    onChange={() => (newCvFile ? setSelectedCv("new") : null)}
                    className="w-5 h-5 text-red-600"
                    disabled={!newCvFile}
                  />
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                  <div className="flex-1 min-h-12 md:min-h-14 text-base md:text-lg rounded-lg border border-gray-200 px-3 py-2 flex items-center w-full overflow-hidden">
                    {newCvFile ? (
                      <span className="break-all sm:truncate md:break-all lg:truncate">
                        {newCvFile.name}
                      </span>
                    ) : (
                  ...
                  <Button
                    ...
                    className="bg-red-600 hover:bg-red-700 text-white h-10 md:h-14 text-base md:text-lg rounded-lg whitespace-nowrap sm:min-w-[120px]"
                  >
                    Choose File
                  </Button>
                </div>
        ...
        <div className="w-full flex flex-col md:flex-row gap-5 justify-center mb-2">
          <div className="flex flex-col md:flex-row gap-5 w-full max-w-4xl mx-auto">
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="w-full bg-red-600 hover:bg-red-700 text-white text-base md:text-lg rounded-lg py-4 md:py-6"
        >
